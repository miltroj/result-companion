...
def build_chunkable(
    ...
    """Builds a ChunkableResult from output.xml with tag filtering and config-driven fields.
    ...
    Returns:
        ChunkableResult ready for iteration.
    """
    ...
    return ChunkableResult.from_config(
        source=output,
