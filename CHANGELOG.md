...
- Project metadata now points to the official homepage.
...
[0.1.0]: https://github.com/miltroj/result-companion/compare/v0.0.17...v0.1.0

## [0.0.17] - 2026-04-27

### Added
- `rendering.exclude_fields` — omit Robot Framework fields from LLM input; field reference and presets in docs (#75)
- `--debug-log` — write each LLM request and full response to a file to tune system prompts and inspect how changes affect answers (#75)

### Changed
- Result → LLM text pipeline: new chunker and context-aware renderer; README token-efficiency and examples updated (#75)

[0.0.17]: https://github.com/miltroj/result-companion/releases/tag/v0.0.17
